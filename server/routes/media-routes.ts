...
mediaRoutes.use('/conversations/:conversationId', userInConversationMiddleware, (req, res, next) => {
  const { conversationId } = req.params;
  express.static(`./uploads/conversations/${conversationId}/`)(req, res, next);
});
